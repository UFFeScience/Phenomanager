...
public class VirtualMachineConfig extends BaseApiEntity {
	...
	@Transient
	private Integer amountInstantiated;
	...
	public VirtualMachineConfig(VirtualMachineConfigBuilder builder) {
		...
		this.amountInstantiated = builder.amountInstantiated;
	...
	public Integer getAmountInstantiated() {
		return amountInstantiated;
	}

	public void setAmountInstantiated(Integer amountInstantiated) {
		this.amountInstantiated = amountInstantiated;
	}
	...
	public static class VirtualMachineConfigBuilder extends BaseApiEntityBuilder {
		...
		public VirtualMachineConfigBuilder executionEnvironment(ExecutionEnvironment executionEnvironment) {
			this.executionEnvironment = executionEnvironment;
			return this;
		}
		...
		public VirtualMachineConfigBuilder amountInstantiated(Integer amountInstantiated) {
			this.amountInstantiated = amountInstantiated;
			return this;
		}

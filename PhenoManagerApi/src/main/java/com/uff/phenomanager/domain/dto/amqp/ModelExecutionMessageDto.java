...
public class ModelExecutionMessageDto implements Serializable {
	...
	public String toString() {
		return "ModelExecutionMessageDto [computationalModelSlug=" + computationalModelSlug + ", modelExecutorSlug="
				+ modelExecutorSlug + ", modelMetadataExtractorSlug=" + modelMetadataExtractorSlug + ", userSlug="
				+ userSlug + ", executionDate=" + executionDate + ", computationalModelVersion="
				+ computationalModelVersion + ", executionCommand=" + executionCommand + "]";
	}
